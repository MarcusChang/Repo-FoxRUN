...
var GetAppName = requireGaia('/tests/util/performance/getappname.js');
var MemInfo = requireGaia('/tests/util/performance/meminfo.js');
    ...
    reportRunDurations: function(runResults) {
      ...
      for (var name in runResults) {
       ...
       // console.log('this.start',start);
        //console.log('this.results[name]',this.results[name]);
      }
